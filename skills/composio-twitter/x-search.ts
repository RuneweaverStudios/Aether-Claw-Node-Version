 ...
 *   --save                     Save results to X_RESEARCH_DRAFTS or ~/clawd/drafts/
...
const DRAFTS_DIR =
  process.env.X_RESEARCH_DRAFTS ||
  join(process.env.HOME || process.env.USERPROFILE || "", "clawd", "drafts");
...
Search options:
  ...
  --no-replies               Exclude replies
  --save                     Save to X_RESEARCH_DRAFTS or ~/clawd/drafts/
